...
func TestGetUserFollowersFromRepository_WhenItReturnsSuccess(t *testing.T) {
	setUpRepository(t)
	username := "usernameA"
...
func TestErrorOnGetUserFollowersFromRepository_WhenGetUserFollowersFails(t *testing.T) {
	setUpRepository(t)
	username := "usernameA"
	lastFollowerId := "follower4"
	limit := 4
